...
if (Array.indexOf === undefined) {
 ...
 (function(window,document,undefined){
    ...
    playingCards.card.prototype.numericRank = function() {
        return playingCards.defaults.numericRanks[this.rank];
    }

    playingCards.card.prototype.toJSON = function() {
        return Generic_toJSON("playingCards_card", this);
    };
    playingCards.card.fromJSON = function(value) {
        return Generic_fromJSON(playingCards.card, value.data);
    };
    /**
     * Compare functions
     */
    ...
    playingCards.prototype.toJSON = function() {
        return Generic_toJSON("playingCards", this);
    };
    playingCards.fromJSON = function(value) {
        return Generic_fromJSON(playingCards, value.data);
    };
